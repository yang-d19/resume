...
\resumeSubHeadingListStart
    \resumeSubheading
        ...
        \begin{itemize}[leftmargin=0pt]
            ...
            \item[] \small{\textit{Activities}: Particiapted in arXiv's paper relationship database contruction and GCP deployment.}
        \end{itemize}
    \resumeSubheading
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalsize{\item{
     \textbf{Languages \& Tools}{: C · C++ · Python · Rust \hspace{2pt} | \hspace{3pt} Git · CMake · Docker } \\
     \textbf{Frameworks}{: RaspberryPi · Arduino · STM32 · ROS · SLAM · Tensorflow · Pytorch} \\
    }}
 \end{itemize}
...
\resumeSubheading
        {3D Bin Packing Simulator for Reinforcement Learning Algorithm Test}{Sept 2021 -- Feb 2022}
        {Tsinghua University}{}
    \resumeItemListStart
        \small
        \resumeItem{Developed a simulation environment in Python, which provides the interface for researchers to apply different packing strategies and get the feedback instantly. Now open sourced in GitHub: \href{https://github.com/yang-d19/Packing-3D-RL}{\textcolor{blue}{yang-d19/Packing-3D-RL} }
        }
        \resumeItem{Tested several Reinforcement Learning based space utilization strategies in this simulator and improved them.}
    \resumeItemListEnd
...
\resumeSubheading
    {Team Leader · Intelligent Car Design Competition}{Aug 2020 - Oct 2020}
    {Tsinghua University}{}
    \resumeItemListStart
        \small
        \resumeItem{Build an intelligent car from scratch with STM32, infrared detector, electric motor, gyroscope, zigbee module etc, which supports receiving instructions from a controller or from referee machine.}
        \resumeItem{Participated with the car in the competition that aims to find way through random generated mazes and complete assigned tasks, and got into the final eight.}
\resumeItemListEnd
