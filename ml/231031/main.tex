...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalsize{\item{
     ...
     \textbf{Frameworks}{: Node.js · Django · Apache Spark · Deequ · Tensorflow · Pytorch · Spacy} \\
     \textbf{Tools \& Services}{: Git · CMake · Docker · CI/CD · WSL · Vim · AWS · GCP }
    }}
 \end{itemize}
...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
    {Software Engineer Intern · arXiv}{Sept 2023 --  Present}
    {Ithaca, NY, United States}{}
    \resumeItemListStart
        \small
        \resumeItem{Participated in the maintainance and improvement of arXiv database in the Google cloud platform.}
        \resumeItem{Built a robust text parser that extract key information like affiliated institutions from source files, 
        which employs basic fuzzy matching method and transfer learning model based on Spacy NLP library. }
        \resumeItem{Generated relationship structure tables and visualization graphs with extracted information. }
...
\resumeSubHeadingListStart
    \resumeSubheading
      {Lecturer · Science and Technology Camp for Primary and Secondary School}{Jul -- Aug 2020}
      {Rugao Science and Technology Association}{Rugao, Jiangsu, China}
      \resumeItemListStart
        \small\resumeItem{Taught basic programming and computer structure knowledge to students as a volunteer lecturer. }
        \resumeItemListEnd
\resumeSubHeadingListEnd
