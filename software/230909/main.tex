...
\begin{itemize}[leftmargin=0.15in, label={}]
    \normalsize{\item{
     ...
     \textbf{Frameworks}{: Node.js · Django · Apache Spark · Tensorflow · Pytorch} \\
...
\resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \small\resumeItem{Taught basic programming and computer structure knowledge to students as a volunteer lecturer. Helped the students get familiar with Python language syntax and spurred their interest in computer science.}
        \resumeItemListEnd
\resumeSubHeadingListEnd
